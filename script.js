window.addEventListener('load', function(){
    ...
    class  Particle{
        ...
        update(){
            ...
            this.y += this.speedY;
            if (this.y > this.game.heigth + this.size || this.x < 0 - this.size)  this.markedForDeletion=true;
    ...
    class UI{
        ...
        draw(context){
            ...
            context.fillText('Time: '+formattedTimer, 20, 100)
            //game over messages
            if (this.game.gameOver){
                ...
                if (this.game.score > this.game.winnigScore){
                    ...
                    messages1="Game Over!";
                    messages2="Better luck next time!";
                }
                context.font='50px ' + this.fontFamily;
                context.fillText(messages1, this.game.width / 2, this.game.height / 2 - 20);
                context.font='25px ' + this.fontFamily;
                context.fillText(messages2, this.game.width / 2, this.game.height / 2 + 20);
            }
            // ammo
    ...
    class Game{
        ...
        update(deltaTime){
            ...
            this.enemies=this.enemies.filter(enemy =>{ return !enemy.markedForDeletion });
